...
class ModifiedRepoBrowserTab(QWidget):
    ...
    def set_avatar(self, url):
        try:
            ...
            self.setStyleSheet("font-size: 24pt; color: #a0a0ff; background: #3f3f5f; border-radius: 30px;")
...
class LoginWindow(QDialog):
    ...
    def __init__(self):
        ...
        # Add login prompt
        login_prompt = QLabel("Select a GitHub Account")
        login_prompt.setStyleSheet("font-size: 16pt; font-weight: bold; color: #a0a0ff; margin-bottom: 10px;")
        login_prompt.setAlignment(Qt.AlignCenter)
        content_layout.addWidget(login_prompt)
